...
class HomeScene(Scene):
    ...
    def __init__(self, mainApp: pygame.Surface,
        ...
        self.btn_images = [
            pygame.transform.scale(img, (max_width, max_height))
            for img in btn_images_raw
        ]
    ...
    def loopScene(self, events: list[pygame.event.Event]):
        ...
        for i, img in enumerate(self.btn_images):
            ...
            if is_selected:
                ...
                pulse = math.sin(self.animation_time *
                                 self.glow_speed) * 0.5 + 0.5  # 0 to 1
                ...
                glow_surface = pygame.Surface(
                    (width + glow_padding, height + glow_padding),
                    pygame.SRCALPHA)
...
if __name__ == "__main__":
    ...
    print(
        "Controls: Arrow keys (UP/DOWN) to navigate, ENTER/SPACE to select, ESC to quit"
    )
